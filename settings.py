...
LAION_AES_ROOT = str(DATA_ROOT / "laion-aesthetic" / "part-{00000..00127}" / "{00000..00040}.tar")
BLIP3_SHORT_ROOT = str(DATA_ROOT / "BLIP3o-Pretrain-Short-Caption" / "{00000..01832}.tar")
BLIP3_LONG_ROOT = str(DATA_ROOT / "BLIP3o-Pretrain-Long-Caption" / "sa_{000000..000999}.tar")
BLIP3_JOURNEY_ROOT = str(DATA_ROOT / "BLIP3o-Pretrain-JourneyDB" / "JourneyDB_{000..194}.tar")
...
MJHQ_FID_STATS = str(EVAL_ASSET_ROOT / "mjhq" / "jax_mjhq_fid_stats_512.npz")
MJHQ_CAPTION_FILE = str(EVAL_ASSET_ROOT / "mjhq" / "mjhq-30k-captions.json")
